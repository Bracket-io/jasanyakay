...
const Work = () => {
  ...
  const projects = [
    ...
    {
      category: "VC",
      title: "Supply Change Capital Due Diligence",
      impact: "Strategic investment analysis",
      company: "Supply Change Capital",
      description: "Worked as an analyst supporting due diligence operations, leveraging data analysis to evaluate investment opportunities and deliver actionable insights for portfolio decision-making.",
      tags: ["Due Diligence", "Airtable", "Investment Analysis", "Data-Driven"],
      featured: false,
    },
    {
      category: "Product",
      title: "Lights Back On Website Revamp",
      impact: "Georgian residents electricity access",
      company: "Lights Back On",
      description: "Revamped the website of a nonprofit organization connecting Georgian residents with access to electricity, improving user experience and increasing community reach.",
      tags: ["Nonprofit", "Web Development", "Social Impact", "UX Design"],
      featured: false,
    },
    {
      category: "Product",
      title: "Housing+Health Lab Research Website",
      impact: "Research lab digital presence",
      company: "Housing+Health Lab",
      description: "Managed a team to create a WordPress website for a research lab, establishing their digital presence and facilitating knowledge sharing across the research community.",
      tags: ["WordPress", "Team Management", "Research", "Web Development"],
      featured: false,
    },
    {
      category: "Product",
      title: "Johns Hopkins Hospital Emergency Response System",
      impact: "Emergency team operations",
      company: "Johns Hopkins Hospital",
      description: "Collaborated with a team of 4 to revamp emergency boxes used by the response team at Johns Hopkins Hospital, optimizing critical response protocols and equipment organization.",
      tags: ["Healthcare", "Emergency Systems", "Team Collaboration", "Process Design"],
      featured: false,
    },
    {
      category: "Product",
      title: "Reforge30 Event Platform",
      impact: "30-day engagement system",
      company: "Reforge30",
      description: "Created a 30-day event platform on Airtable to streamline event management, participant tracking, and engagement workflows, delivering a scalable solution for community-driven challenges.",
      tags: ["Airtable", "Event Management", "Platform Design", "Automation"],
      featured: false,
    },
  ];
